...
| The actual-prefix rank Gamma is exactly evaluable in at most `floor(log_2 n)` shortcut steps; every primitive expanding parity period has guarded ordinary sources with stepwise Gamma contraction through any requested finite horizon. | All competing actual prefixes are covered, including the unprescribed future. Sources vary with the horizon; odd-displacement residuals and compulsory rank spikes remain. | [Actual-prefix statements and proof](research/integrated/rank-merging/README.md#actual-prefix-rank) |
| A forward-closed clearance forest leaves surviving mass at most `12/2^48` for the fixed input `1_U/R_*^2` after 52 quarter-unsafe returns, at every subsequent return. | A genuine all-future bound, but with a positive residual; not natural density, zero exceptional mass, or a reusable contraction factor. | [Source tails and clearance](research/integrated/exceptional-mass/README.md#source-tails-and-clearance) |
...
**Current integration:** the September 2026 [mass/rank consolidation](reports/prepublic-2026-09-05/integration/README.md) and [reviewer-D follow-up](reports/prepublic-2026-09-05/integration-d/README.md) build on the earlier baseline; the linked records pin exact source coverage. The [tail/rank integration record](reports/integration-2026-09-08/README.md) adds exact reviewed source coverage for the source-tail, clearance, linear-frontier, expanding-word and actual-prefix packets. Later branch revisions remain exploratory unless separately reviewed and integrated.
