...
| L-9906 | Lemma | Commuting accelerated blocks share one primitive word root, while every primitive cycle cut has a nonzero denominator-divisible commutator | PROPOSED / EXACT GRAMMAR REDUCTION | L-9904; issue #9; PR11 compressed-cycle grammar |
| L-9907 | Lemma | The cyclic cycle matrix has Smith form `diag(1,...,1,|D|)`, and its augmented all-ones class vanishes exactly for an exact cycle | PROPOSED / EXACT EQUIVALENCE AND METHOD BOUNDARY | L-9904; L-9906 for cut comparison |
| L-9908 | Lemma | Centered forced tails have a strict exponential height cone, while every periodic control tail has a finite rational lasso obstruction | PROPOSED / CROSS-DIRECTION RECONSTRUCTION AND HEIGHT EXTENSION | elementary affine iteration; T-9827 for the run crosswalk; live issue-#40 D-8701/L-8701/R-8701 overlap |
| L-9909 | Lemma | Genuine primitive denominator prime powers can be silent on frontier-scale primitive words, but the lifted family is obstructed and every full-denominator order reduction is letterwise vacuous | PROPOSED / EXACT METHOD BOUNDARY | L-9904, L-9906; Zsigmondy; rational Matveev specialization |
| L-9910 | Lemma | Centering at the trivial fixed point makes non-2 valuations sparse, collapses every fixed neutral-tail family to finitely many divisor tests, and excludes up to four exceptional letters | PROPOSED / EXACT SEARCH REDUCTION | L-9904 |
| L-9911 | Lemma | Bounded run languages transfer to explicit phase-complexity ceilings, excluding all mechanical and Sturmian maximal-run schedules in the `64 -> 81` and `4 -> 5` charts | PROPOSED / EXACT APERIODIC-FAMILY EXCLUSION | T-9801; elementary one-sided run coding |
| L-9912 | Lemma | No positive accelerated cycle word has exactly five valuations different from two | PROPOSED / EXACT FINITE CERTIFICATE | L-9904, L-9910 |
| L-9913 | Lemma | No positive accelerated cycle word has exactly six valuations different from two | PROPOSED / EXACT FINITE CERTIFICATE | L-9904, L-9910, L-9912 |
| L-9914 | Lemma | Full prime-power excess paths glue losslessly, and their local periods must span a primitive word | PROPOSED / EXACT CONSTRUCTIVE REDUCTION | L-9904, L-9909 |
| L-9915 | Lemma | A deterministic finite controller with one zero-tested additive counter has ultimately periodic output | PROPOSED / ISOLATED CROSS-DIRECTION OBSTRUCTION | elementary finite functional graphs; L-9908 for the centered consequence |
