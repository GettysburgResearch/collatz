...
- [`wave twenty-five stopping checkpoint`](../../reports/gpt56-synthesis-01/2026-07-22-29-cross-direction-wave-twenty-five-stopping-checkpoint.md)
...
| [`L-9912`](claims/L-9912-five-defect-positive-cycle-exclusion.md) | Issue #9 sparse-cycle frontier | Centered contraction, a largest-neutral-gap height cutoff, and a complete exact divisor table exclude every positive cycle word with exactly five non-2 valuations. |
| [`L-9913`](claims/L-9913-six-defect-positive-cycle-exclusion.md) | Issue #9 sparse-cycle frontier | A complete contraction classification leaves four six-defect types; monotone gap bounds make them finite and exact divisibility rejects every residual word, raising the centered support floor to seven. |
| [`L-9914`](claims/L-9914-cross-prime-excess-path-crt-compiler.md) | Issue #9 cross-prime cycle frontier | Compatible prime-power excess paths reconstruct at most one word because `ord_D(2)>A-k`; local powered aliases can cancel only while their periods collectively span every primitive word. |
| [`L-9915`](claims/L-9915-additive-one-counter-periodic-output-obstruction.md) | Issues #40/#43 causal-controller frontier | Any deterministic finite controller with one zero-tested additive counter, even with fixed residue observations and positive drift, emits an ultimately periodic word and therefore cannot generate a positive centered forced tail. |
...
| [`T-9820`](claims/T-9820-base-cell-joint-newton-carry.md) | PR #3/PR #33 cap-carry frontier | The base cell and third-symbol offset factor through one inverse unit; `Z mod64` and `J mod64` are affinely equivalent same-scale information, while parity leaves a full growing carry on one or three lanes. |
