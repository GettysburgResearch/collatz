...
| [L-6173](L-6173-itinerary-implies-value.md) | PROVED (one direction) | The itinerary condition **implies** the value condition, for every `n`, in two lines. The converse holds pointwise for every `n <= 2*10^9` — and **is the classical coefficient-stopping-time question**, open since 1976. Do not attack it here. |
