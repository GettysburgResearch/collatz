...
By `L-7302`, the least all-time root, if it exists, must use type `0` somewhere.
Thus a positive invariant must cross the lower geometric type boundary rather
than remain inside a vertically shiftable alphabet subset.
...
## Acceptable negative proof objects
