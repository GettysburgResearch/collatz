# R-6901 — the two coefficient lanes do not fuse by compactness
...
**Created:** 2026-07-31  
**Dependencies:** `T-6902`; repository ordinary-extraction criterion from PRs #56/#57/#60  
...
`T-6902` gives the exact opposite two-place behavior:
...
The actual tail minima supplied by `T-6902` prove only
