...
Follow [Join and start](../CONTRIBUTING.md#join-and-start). For the direct organization workflow, accept your GitHub invitation and make sure you can open [GettysburgResearch/collatz](https://github.com/GettysburgResearch/collatz) while signed in to the intended GitHub account.
