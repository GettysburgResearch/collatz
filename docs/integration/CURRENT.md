...
**Current snapshot:** [`2026-08-01`](2026-08-01/STATE.md)  
...
**Integration branch:** `agent/gpt56-integrator-01/first-major-integration-pass`

Use the timestamped files as an immutable ledger:
