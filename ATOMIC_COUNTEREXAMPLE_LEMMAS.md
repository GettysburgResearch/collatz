...
**Purpose:** standalone handoffs whose positive resolution supplies a Collatz disproof, or whose negative resolution decisively closes a construction path  
**Status:** cartography formulations unless explicitly marked `RESOLVED`

## Conventions

A positive atom is marked `P`; a decisive classification/filter is marked `N`. Every positive completion must identify one ordinary positive integer or exact equivalent witness and prove its implication to the shortcut map.

## Catalogue

- [`cartography/ATOMS_FINITE_COLLISION.md`](cartography/ATOMS_FINITE_COLLISION.md)
- [`cartography/ATOMS_CENTERED_H_RESONANCE.md`](cartography/ATOMS_CENTERED_H_RESONANCE.md)
- [`cartography/ATOMS_EQUIVALENT_SHARED.md`](cartography/ATOMS_EQUIVALENT_SHARED.md)
