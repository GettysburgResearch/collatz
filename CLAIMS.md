...
| C-0003 | fiber-width growth | `log₂ width_max(L)/L → c ≈ 0.19` (in particular supercritical fiber widths are unbounded — answers PR #3's Q-0002 empirically). Naive composition proof fails (carry-offset obstruction, recorded); uniform model refuted (R-0003) | EMPIRICAL (records 2,3,4,5,8,12,18,26 at L = 6…25; slope 0.176→0.188 rising) | `fiber_widths.py` → `fiber-widths.log` | `LADDER.md` §3 | — |
