#!/usr/bin/env python3
"""Build the exact X-9612 2,048-block mechanical library certificate."""
...
P_NUM = 19
Q_DEN = 30
SWAP_POSITIONS = (0, 2, 4, 7, 9, 12, 15, 18, 20, 23, 26)
...
def build_payload() -> dict[str, Any]:
    ...
    if span <= dyadic_multiplier:
        raise AssertionError("the stronger Q+P theorem is not load-bearing")
    if span >= dyadic_multiplier + odd_multiplier:
        raise AssertionError("the sharp L-9608 carry hypothesis fails")
    ...
    return {
        ...
        "theorem_interface": {
            "span_exceeds_Q": span > dyadic_multiplier,
            "sharp_carry_hypothesis": span < dyadic_multiplier + odd_multiplier,
